...
void print_order_info()
{
	...
	_settextcolor(WHITE);
	_setbkcolor(RED);
	_outtext("FOFONSO'S WUMPUS HUNT");
	_settextcolor(YELLOW);
	_outtext(": The hottest new game for ");
	...
	_outtext("        ");
	_setbkcolor(RED);
	_outtext(" ______________________________________________________________ ");
	_setbkcolor(BLACK);
	_outtext("        ");
	_outtext("        ");
	_setbkcolor(RED);
	...
	_outtext("        ");
	_setbkcolor(RED);
	_outtext(" Explore a dark cave filled with ");
	_settextcolor(LIGHTCYAN);
	_outtext("TREASURE");
	_settextcolor(YELLOW);
	_outtext("... But... Be careful  ");
	_setbkcolor(BLACK);
	_outtext("        ");
	_outtext("        ");
	_setbkcolor(RED);
	_outtext(" for you are not alone... The cave houses a ");
	_settextcolor(GREEN);
	_outtext("TERRIBLE");
	_settextcolor(YELLOW);
	_outtext(" and ");
	...
	_outtext("        ");
	_setbkcolor(RED);
	_outtext(" creature called ");
	_settextcolor(BROWN);
	_outtext("THE TERRIBLY SMELLY WUMPUS");
	_settextcolor(YELLOW);
	_outtext("... That and It is   ");
	_setbkcolor(BLACK);
	_outtext("        ");
	_outtext("        ");
	_setbkcolor(RED);
	_outtext(" filled with bottomless pits of ");
	_settextcolor(MAGENTA);
	_outtext("DEATH");
	_settextcolor(YELLOW);
	_outtext(", but don`t worry, you     ");
	_setbkcolor(BLACK);
	_outtext("        ");
	_outtext("        ");
	_setbkcolor(RED);
	_outtext(" came prepared.  Pretty ");
	_settextcolor(MAGENTA);
	_outtext("BADLY");
	_settextcolor(YELLOW);
	_outtext("... But prepared nonetheless.      ");
	_setbkcolor(BLACK);
	_outtext("        ");
	_outtext("        ");
	_setbkcolor(RED);
	...
	_outtext("        ");
	_setbkcolor(RED);
	_outtext(" This game was created by ");
	_settextcolor(LIGHTCYAN);
	_outtext("Affonso Amendola");
	_settextcolor(YELLOW);
	_outtext(", a Brazilian         ");
	_setbkcolor(BLACK);
	_outtext("        ");
	_outtext("        ");
	_setbkcolor(RED);
	_outtext(" undergrad student at the ");
	_settextcolor(MAGENTA);
	_outtext("Institute of Astronomy, Geophysics    ");
	_setbkcolor(BLACK);
	_outtext("        ");
	_outtext("        ");
	_setbkcolor(RED);
	_outtext(" and Atmospheric Sciences");
	_settextcolor(YELLOW);
	_outtext(" of the University of Sao Paulo,       ");
	_setbkcolor(BLACK);
	_outtext("        ");
	_outtext("        ");
	_setbkcolor(RED);
	_outtext(" after finding an old book on ");
	_setbkcolor(LIGHTGRAY);
	_settextcolor(RED);
	_outtext("V");
	_settextcolor(GREEN);
	...
	_outtext("        ");
	_setbkcolor(RED);
	_outtext(" Hacker Clube");
	_settextcolor(YELLOW);
	_outtext(", a hackerspace in Sao Paulo, and spending a       ");
	_setbkcolor(BLACK);
	_outtext("        ");
	_outtext("        ");
	_setbkcolor(RED);
	_outtext(" a sleepless weekend making it.                                 ");
	_setbkcolor(BLACK);
	_outtext("        ");
	_outtext("        ");
	_setbkcolor(RED);
	_outtext(" Thank you so much for playing. I hope you had fun.             ");
	_setbkcolor(BLACK);
	_outtext("        ");
	_outtext("        ");
	_setbkcolor(RED);
	...
	_outtext("        ");
	_setbkcolor(RED);
	_outtext(" Affonso Amendola, affonso.gino.neto@usp.br                     ");
	_setbkcolor(BLACK);
	_outtext("        ");
	_outtext("        ");
	_setbkcolor(RED);
	_outtext(" http://www.github.com/affonsoamendola/wumpusvga                ");
	_setbkcolor(BLACK);
	_outtext("        ");
	_outtext("        ");
	_setbkcolor(RED);
	_outtext(" 1:21 AM, 11 July 2018, Sao Paulo, Brazil, Earth                ");
	_setbkcolor(BLACK);
	_outtext("        ");
	_outtext("        ");
	_setbkcolor(RED);
